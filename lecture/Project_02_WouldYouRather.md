...
- 1단계 - State 모양을 디자인하고 reducer를 만듭니다.
- 2단계 - Redux Store를 만듭니다. logger middleware (옵션)와 Redux Thunk 미들웨어를 연결하십시오 (또는 Redux Saga 등을 사용할 수 있음). 
- 3단계 - Store에 액세스해야하는 각 보기마다 Component를 작성하고 Store에 연결하십시오. 
- 4단계 - 마지막 단계에서 작성한 Component에 대해 action 및 action creator를 작성하십시오. 모든 것이 올바르게 작동하는지 확인하십시오. 
- 5단계 - Store에 액세스해야하는 각 Component에 대해 3단계 및 4단계를 반복하십시오. 
- 6단계 - Presentation Component를 작성하고 모든 것이 올바르게 작동하는지 확인하십시오. 
- 7단계 - React Router 추가 
- 8단계 - 마무리 손질을 추가하고 프로젝트가 rubric을 충족하는지 확인하십시오.
